...
@media only screen and (max-width: 600px) {
  ...
  invoice-link {
    ...
    Number(balanceDue) <= 0 ? "" : moment(dueDate).format("MMM Do YYYY")
      ...
      <div class"footer">
          <a href="https://invoice_gen.com">
          <img class="footer-logo" src="https://webtechinventor.com/assets/img/logo/logo1.svg" alt="logo-invoice"/>
        </a>
      </div>
    <p style="text-align: center">Make beautiful invoice for free at invoice_gen.com</p>
    </div>
    </body>
</html>`;
}
