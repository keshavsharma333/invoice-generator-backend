      ...
      user
        ...
        .then((result) => {
          transporter.sendMail({
            to: user.email,
            from: `Invoice Gen <${process.env.SMPT_MAIL}>`,
            subject: "Password reset request",
            html: `
                    <p>You requested for password reset from Invoicing application</p>
                    <h5>Please click this <a href="https://invoice_gen.com/reset/${token}">link</a> to reset your password</h5>
                    <p>Link not clickable?, copy and paste the following url in your address bar.</p>
                    <p>https://invoice_gen.com/reset/${token}</p>
